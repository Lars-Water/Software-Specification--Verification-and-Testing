...
propertyShow  = do
    ...
    putStrLn ("Value of the first ordered property is: " ++ ( show ((list !! 0) x )))
    putStrLn ("Value of the second ordered property is: " ++ ( show ((list !! 1) x )))
    putStrLn ("Value of the third ordered property is: " ++ ( show ((list !! 2) x )))
    putStrLn ("Value of the fourth ordered property is: " ++ ( show ((list !! 3) x ))  ++ "\n")
    putStrLn ("Value of the known strongest property is: " ++ ( show ((descendingList !! 0) x )))
    putStrLn ("Value of the known second strongest property is: " ++ ( show ((descendingList !! 1) x )))
    putStrLn ("Value of the known third strongest property is: " ++ ( show ((descendingList !! 2) x )))
    putStrLn ("Value of the known weakest property is: " ++ ( show ((descendingList !! 3) x )))
